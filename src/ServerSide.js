...
export default function serverMain(stProd) {
    ...
    //-------------------------------------------------
    function calcRTPs1 (stProd, histData) {
...
let rollArr = [];
let r1 = histData.indCumulArray.map(el => el[0][i]);
...
let r1 = [];
            ...
            for (let j=i; j<i+t; j++) {    // from callPr till endDate - RTP for stProd
